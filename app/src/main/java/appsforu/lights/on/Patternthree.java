        ...
        mRunnable[0] = new Runnable() {
            ...
            public void run() {
                ...
                if (count[0]==0) {
                    turn_ON();
                    count[0] = 1;
                    m_Handler.postDelayed(mRunnable[0], 70);// move this inside the run method
                } else if(count[0]==1){
                    turn_off();
                    count[0] = 2;
                    m_Handler.postDelayed(mRunnable[0], 70);// move this inside the run method
                    ...
                    turn_ON();
                    count[0] = 7;
                    m_Handler.postDelayed(mRunnable[0], 10);// move this inside the run method
                } else if(count[0]==7){
                    turn_off();
                    count[0] = 8;
                    m_Handler.postDelayed(mRunnable[0], 10);// move this inside the run method
